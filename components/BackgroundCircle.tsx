...
const BackgroundCircle = (props: Props) => {
  return (
    ...
    >
      <div className="absolute border rounded-full h-[200px] w-[200px] animate-ping mt-52" />
      <div className="rounded-full border border-[#333333] h-[300px] w-[300px] absolute mt-52" />
      <div className="rounded-full border border-[rgb(51,51,51)] h-[500px] w-[500px] absolute mt-52" />
